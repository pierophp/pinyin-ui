    ...
    >
      <md-dialog-content>
        <div class="checkbox-container">
          <input
            type="checkbox"
            id="open-verses-as-popup"
            v-model="versesShowAsModalInput"
          />
          <label for="open-verses-as-popup">{{
        ...
        <div class="checkbox-container">
          <input
            type="checkbox"
            id="open-chapter-on-load-input"
            v-model="openChapterOnLoadInput"
          />
          <label for="open-chapter-on-load-input">{{
