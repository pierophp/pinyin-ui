...
function separate(pinyin) {
  return pinyin
    ...
    // eslint-disable-next-line
    .replace(new RegExp('([' + vowels + 'v])([^' + vowels + '\w\s])([' + vowels + 'v])', 'i'), '$1 $2$3') // assumes correct Pinyin (i.e., no missing apostrophes)
    // eslint-disable-next-line
    .replace(new RegExp('([' + vowels + 'v])(n)(g)([' + vowels + 'v])', 'i'), '$1$2 $3$4') // assumes correct Pinyin, i.e. changan = chan + gan
    // eslint-disable-next-line
