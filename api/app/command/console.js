...
program.version('0.0.1').command('unihan-load', 'Unihan load');

program.version('0.0.1').command('tatoeba-load', 'Tatoeba load');

program.version('0.0.1').command('tatoeba-references', 'Tatoeba references');
...
program.version('0.0.1').command('bible-import', 'Import Bible');
